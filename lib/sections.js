...
import HeroVerticalSplit from '@/components/sections/HeroVerticalSplit'
...
export const SECTIONS = [
  ...
  {
    id: 'hero-vertical-split',
    name: 'Hero Vertical Split',
    component: 'HeroVerticalSplit',
    usableOn: ['home'],
    description: 'Vertical split hero - product left, lifestyle right, 50/50 panels',
  },
  {
    id: 'before-after',
