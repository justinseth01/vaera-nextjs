...
export default function BeforeAfterSlider() {
  ...
  return (
    <section ref={sliderRef} id="results" className="section-padding bg-vaera-gray">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-xs font-mono text-vaera-navy/50 uppercase tracking-widest mb-4 block">Precision Matters</span>
          ...
          <p className="font-poppins font-light text-vaera-navy/70 max-w-2xl mx-auto">
            Drag the slider to compare skin damage. Slow, overlapping penetrations from competitors tear the skin — Vaera&apos;s ultra-fast actuation creates clean, precise micro-channels.
          </p>
        </div>

        <div
          ref={containerRef}
          className="relative max-w-4xl mx-auto aspect-[4/3] rounded-4xl overflow-hidden cursor-ew-resize select-none shadow-2xl"
