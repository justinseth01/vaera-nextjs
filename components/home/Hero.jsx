  ...
  return (
    <section className="relative md:min-h-screen overflow-hidden bg-gradient-to-br from-white via-vaera-gray to-vaera-ice/20">
      ...
      <div className="relative md:min-h-screen flex flex-col md:flex-row md:items-center pt-20 md:pt-0">
        ...
        {/* Content - Text side */}
        <div className="order-2 md:order-1 md:w-1/2 px-6 md:pl-12 lg:pl-24 md:pr-8 pb-12 md:pb-0">
          {/* Line */}
        ...
        <div className="order-1 md:order-2 md:w-1/2 flex items-center justify-center px-6 md:px-8 lg:px-16 pt-6 pb-16 md:py-0">
          <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-xl aspect-square overflow-hidden shadow-2xl shadow-vaera-navy/20">
