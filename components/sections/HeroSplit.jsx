...
export default function HeroSplit() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col lg:flex-row">
      {/* Right Side - Light Ice-Blue Product Display - Shows First on Mobile */}
      <div className="relative lg:w-[45%] lg:order-2 bg-[#EEF6FA] flex items-center justify-center px-6 py-20 lg:py-0 min-h-[600px] lg:min-h-0">
      ...
      {/* Left Side - Dark Navy Content - Shows Second on Mobile */}
      <div className="relative lg:w-[55%] lg:order-1 bg-vaera-navy flex items-center justify-center px-6 py-20 lg:py-0">
        <div className="max-w-xl w-full lg:ml-auto lg:mr-16">
          {/* Eyebrow */}
      ...
      {/* Horizontal Measurement Line - Desktop Only */}
